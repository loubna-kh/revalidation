        ...
        ?>
          <div class="agent_stc">
                <form class="agent_search" method="GET">                           
                    <input  name="pnrS" type="text" placeholder="Pnr à chercher" maxlength="6">
                    <input type="submit" class="src_btn" value="chercher" name="searchpnr">
                </form>
                <div class="display_agent">
                    <table>
                     <thead>
                        ...
                        <tbody>
                            <?php
                            if(!empty($_GET['pnrS'])&&isset($_GET['searchpnr'])){
                                 $pnr = $_GET['pnrS'];
                                 $query = "SELECT nagentT, DateT, pnr, nagentC, OptionT, DateC FROM controll WHERE pnr = '$pnr'ORDER BY Id DESC";
